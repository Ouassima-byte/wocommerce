 ...
 */
class I25 extends \WPDeskFIVendor\Mpdf\Barcode\AbstractBarcode implements \WPDeskFIVendor\Mpdf\Barcode\BarcodeInterface
{
    /**
     * @param string $code
    ...
    private function init($code, $printRatio, $checksum)
    {
        ...
        for ($i = 0; $i < $clen; $i = $i + 2) {
            ...
            if (!isset($chr[$charBar]) or !isset($chr[$charSpace])) {
                // invalid character
                throw new \WPDeskFIVendor\Mpdf\Barcode\BarcodeException('Invalid I25 barcode value');
            }
