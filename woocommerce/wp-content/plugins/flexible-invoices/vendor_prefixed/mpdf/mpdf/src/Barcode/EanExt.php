 ...
 */
class EanExt extends \WPDeskFIVendor\Mpdf\Barcode\AbstractBarcode implements \WPDeskFIVendor\Mpdf\Barcode\BarcodeInterface
{
    /**
     * @param string $code
     * @param int $length
    ...
    public function __construct($code, $length, $leftMargin, $rightMargin, $xDim, $barHeight, $separatorMargin)
    {
        ...
        $this->data['sepM'] = $separatorMargin;
    ...
    private function init($code, $length = 5)
    {
        ...
        if ($length == 2) {
            ...
            throw new \WPDeskFIVendor\Mpdf\Barcode\BarcodeException('Invalid EAN barcode value');
        }
