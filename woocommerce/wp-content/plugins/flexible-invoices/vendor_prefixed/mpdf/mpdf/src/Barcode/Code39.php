 ...
 */
class Code39 extends \WPDeskFIVendor\Mpdf\Barcode\AbstractBarcode implements \WPDeskFIVendor\Mpdf\Barcode\BarcodeInterface
{
    /**
     * @param string $code
    ...
    private function init($code, $printRatio, $extended, $checksum)
    {
        ...
        if ($code === \false) {
            throw new \WPDeskFIVendor\Mpdf\Barcode\BarcodeException('Invalid CODE39 barcode value');
        }
        if ($checksum) {
            // checksum
