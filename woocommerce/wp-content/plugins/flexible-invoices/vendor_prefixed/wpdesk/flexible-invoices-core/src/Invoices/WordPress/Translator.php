...
class Translator
{
    ...
    public static $text_domain = 'flexible-invoices-woocommerce';
    ...
    public static function init(\WPDeskFIVendor\WPDesk_Plugin_Info $plugin_info)
    {
        ...
        \add_action('wp_loaded', array(__CLASS__, 'init_wpml'));
    }
