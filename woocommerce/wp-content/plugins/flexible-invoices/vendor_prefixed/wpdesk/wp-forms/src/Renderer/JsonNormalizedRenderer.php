 ...
 */
class JsonNormalizedRenderer implements \WPDeskFIVendor\WPDesk\Forms\FieldRenderer
{
    /**
     ...
     */
    public function render_fields(\WPDeskFIVendor\WPDesk\Forms\FieldProvider $provider, array $fields_data, $name_prefix = '')
    {
        $rendered_fields = [];
