...
if (!\interface_exists('WPDeskFIVendor\\WPDesk_Translatable')) {
    require_once __DIR__ . '/Translatable.php';
}
if (!\interface_exists('WPDeskFIVendor\\WPDesk_Buildable')) {
    require_once __DIR__ . '/Buildable.php';
}
if (!\interface_exists('WPDeskFIVendor\\WPDesk_Has_Plugin_Info')) {
 ...
 */
class WPDesk_Plugin_Info implements \WPDeskFIVendor\WPDesk_Translatable, \WPDeskFIVendor\WPDesk_Buildable, \WPDeskFIVendor\WPDesk_Has_Plugin_Info
{
    /** @var string */
