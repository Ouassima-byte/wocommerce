...
use WPDeskFIVendor\WPDesk\License\Page\LicensePage;
 ...
 */
class LicenseIntegration implements \WPDeskFIVendor\WPDesk\PluginBuilder\Plugin\Hookable
{
    /** @var LicensePage */
    ...
    {
        $plugin_registry = new \WPDeskFIVendor\WPDesk\License\InstalledPlugins();
        $this->license_page = new \WPDeskFIVendor\WPDesk\License\Page\LicensePage($plugin_registry);
