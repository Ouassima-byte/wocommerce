 ...
 */
class LicenseActivation implements \WPDeskFIVendor\WPDesk\License\Page\Action
{
    /**
     * Plugin data.
     *
    ...
    {
        \add_settings_error('api_key_check_text', 'api_key_check_error', \__('Connection failed to the Subscription Key API server. Try again later.', 'flexible-invoices'), 'error');
    }
    /**
    ...
    {
        \add_settings_error('activate_text', 'activate_msg', \__('Plugin activated. ', 'flexible-invoices') . "{$activate_results['message']}.", 'updated');
    }
    /**
     * Activate license.
     *
